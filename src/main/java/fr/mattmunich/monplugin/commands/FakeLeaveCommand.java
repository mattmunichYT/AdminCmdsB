...
public class FakeLeaveCommand implements CommandExecutor, TabCompleter {
	...
	public FakeLeaveCommand(MonPlugin main, Grades grades, Settings settings) {
		this.main = main;
		this.grades = grades;
	...
	public boolean onCommand(CommandSender s, Command cmd, String l, String[] args) {
		...
		if (args.length != 2) {
			p.sendMessage(main.getPrefix() + "§cSintax : /fakeleave <Player> <Grade>");
			return true;
		}
		...
		Bukkit.broadcastMessage(name + "§e s'est déconnecté");
